...
class StatCard {
  final String label;
  final String value;
  final String? delta; // e.g. "+312 this week"
...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  // ⚠️ DEMO DATA — replace with your provider/API call.
  ...
  void _selectNav(String label) {
    ...
    if (LmsResponsive.isMobile(context) && Navigator.canPop(context)) {
      Navigator.pop(context); // close the drawer after picking an item
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // On mobile the sidebar becomes a drawer instead of a fixed column.
      appBar: isMobile
          ? AppBar(
            ...
            child: SingleChildScrollView(
              ...
              child: LmsResponsiveCenter(
                ...
                child: Column(
                  ...
                  children: [
                    if (!isMobile) _TopBar(title: _selected),
...
// ── Top bar (desktop/tablet only — mobile uses the AppBar instead) ──
