...
//   final String? fileType; // only set for note uploads: 'pdf' | 'doc' | 'docx'
//   final int? durationSeconds; // only set for video uploads
...
// }
//
// /// Matches upload.controller.js exactly:
// ///
// /// UPLOAD VIDEO     -> POST   /api/uploads/lesson-video      (field: "video")
// /// UPLOAD NOTE      -> POST   /api/uploads/lesson-note       (field: "note")
// /// UPLOAD THUMBNAIL -> POST   /api/uploads/lesson-thumbnail  (field: "thumbnail")
// /// DELETE VIDEO     -> DELETE /api/uploads/lesson-video      (body: { publicId })
// /// DELETE NOTE      -> DELETE /api/uploads/lesson-note       (body: { publicId })
// /// DELETE THUMBNAIL -> DELETE /api/uploads/lesson-thumbnail  (body: { publicId })
// ///
// /// Note: delete calls only remove the Cloudinary asset. To clear the
// /// field on the lesson's DB row, follow up with
// /// LessonService.updateLesson(removeVideo/removeNote/removeThumbnail: true).
// class LessonUploadService {
//   final String baseUrl;
//
//   LessonUploadService({this.baseUrl = 'http://localhost:3000'});
//
